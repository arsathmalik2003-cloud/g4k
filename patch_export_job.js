...
let code = fs.readFileSync('apps/api/app/Jobs/GenerateReportJob.php', 'utf8');

const oldFetchData = `    private function fetchData(string $key): array
    {
        switch ($key) {
            case 'tasks':
...
const newFetchData = `    private function fetchData(string $key): array
    {
...
fs.writeFileSync('apps/api/app/Jobs/GenerateReportJob.php', code);
console.log('Patched GenerateReportJob.php');
