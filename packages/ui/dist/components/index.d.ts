...
declare function DataTable<TData, TValue>({ columns, data, getRowId, fetchNextPage, hasNextPage, isFetchingNextPage, density, stickyHeader, stickyFirstCol, onRowSelectionChange, onInlineEditSave, }: DataTableProps<TData, TValue>): React__default.JSX.Element;
